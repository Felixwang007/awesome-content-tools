...
BRANCH = "main"
MSG = "add: MCP协议完全指南文章+首页列表+站点地图更新"

# (local_path, remote_path, sha_if_exists_or_None)
FILES = [
    ("docs/articles/mcp-protocol-guide.html", "docs/articles/mcp-protocol-guide.html", None),
    ("docs/index.html", "docs/index.html", "c378931c221ae475bfdec22b76d3fd0361543978"),
    ("docs/sitemap.xml", "docs/sitemap.xml", "e44d2fb30663d3de4530dbbde283f7d0acea3afe"),
]
